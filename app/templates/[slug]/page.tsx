    ...
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section className="mx-auto grid w-full max-w-7xl gap-8 px-5 py-16 sm:px-6 lg:grid-cols-[0.78fr_1.22fr] lg:px-8">
        ...
        <div id="playbook" className="space-y-8">
          ...
          <section className="border border-cyan-200/20 bg-cyan-300/10 p-6 dark:border-cyan-400/20">
      ...
      <section className="border-t border-border bg-surface py-14">
        <div className="mx-auto w-full max-w-7xl px-5 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-black text-foreground">More templates</h2>
          <div className="mt-6 grid gap-4 md:grid-cols-3">
            {relatedTemplates.map((item) => (
              <Link
                key={item.slug}
                href={`/templates/${item.slug}`}
                className="border border-border bg-background p-5 transition hover:border-border-hover hover:bg-surface-hover"
              >
